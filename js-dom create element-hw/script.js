...
//Task
let _list = ["q5nsC5vZri7d", "Lm7CewLM3VVn", "mjYH1ynC1iCv", "OCaDfHpjVD3v"]; 
function removeItemsById(arr, _list) {
    return arr.filter(item => !_list.includes(item.id));
}

goods = removeItemsById(goods, _list);
getList(goods);