...
btn1.addEventListener("click", () => {
    ...
    let filter = goods.filter(obg => obg.store_name === "Əliyev Moda Mərkəzi")
    if (filter.length > 0) {
        prg.innerText = filter.map(item => item.product_name + " ").join(", ");
    }
}) 
...
btn2.addEventListener("click", () => {
    ...
    let filter = goods.filter(obg => obg.store_name === "Zərif Moda")
    if (filter.length > 0) {
        prg.innerText = filter.map(item => item.product_name + " ").join(", ");
    }
}) 
...
btn3.addEventListener("click", () => {
    ...
    let filter = goods.filter(obg => obg.store_name === "Moda Dünyası")
    if (filter.length > 0) {
        prg.innerText = filter.map(item => item.product_name + " ").join(", ");
    }
}) 