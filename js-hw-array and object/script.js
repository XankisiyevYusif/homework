...
// Task 1
function findObjectbyName(arr, objName){
    console.log(arr.find(obj => obj.product_name === objName)) 
}

findObjectbyName(goods, "Kişi şalı")

//Task 2
function filterObjectPriceRange(startPrice, endPrice, arr){
    console.log(arr.filter(obj => startPrice < obj.product_price && obj.product_price < endPrice))
}

filterObjectPriceRange(10, 90, goods)