...
class Program1
{
    ...
    public static void Main()
    {
        ...
        var result1 = debtors.Where(d => (DateTime.Now.Year - d.BirthDay.Year) >= 26 && (DateTime.Now.Year <= 36));
        ...
        var result3 = debtors.Where(d => (d.FullName.Length >= 18 && d.Phone.Count(a => a == 7) >= 2));
        ...
        var result5 = debtors.Where(d => d.Debt >= avarage)
        ...
        var result6 = debtors.Where(d => d.Phone.Contains("8"));
        
        foreach (var item in result6)
        {
            Console.WriteLine($"{item.FullName.Split(" ").Last()}, {DateTime.Now.Year - item.BirthDay.Year}, {item.Debt}");
        }
        ...
        var result9 = debtors.OrderByDescending(d => d.Debt).Take(5);
        ...
        var result10 = debtors.Sum(d => d.Debt);
        Console.WriteLine(result10);

        //    11)2ci dunya muharibesin gormush borclularin siyahisi cixartmaq

        var result11 = debtors.Where(d => d.BirthDay.Year <= 1945);
        ...
        {
            int months = ((d.BirthDay.Month - DateTime.Now.Month) + 12) % 12;
            return (months * 500) >= d.Debt;
        });
